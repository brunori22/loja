...
INSERT INTO provider VALUES(null,?,?,?,1);

/* Address */

insert into address(address_code,public_place,street_name,number_of_street,complement,neighborhood,city,zipcode) 
values(null,'Avenida','Placido Martins',797,'APTO 23','Pedreira','Belém','66085317');
